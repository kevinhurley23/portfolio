...
export default function ProjectGrid() {
  const projects = [
    ...
    },
    {
      ...
      tags: ["jQuery"],
      buildLink:
        "https://kevinhurley23.github.io/Online-Find-and-Replace-Tool/",
    ...
    },
    {
      ...
      description:
        "As a musician, this project really appealed to me. I created this drum machine using React. I improved on freeCodeCamp's design in a few ways. Firstly, rather than using the sounds they provided, I created my own sounds using Native Instruments software. I also made it so that holding down a key does not retrigger the sounds, and I added text on either side of the toggle buttons to clarify their functions. Also, I think mine looks better!",
    },
    {
      ...
      description:
        "I think I improved on freeCodeCamp's design. My calculator has a backspace button in addition to the all clear button. The backspace button returns the last number to the display if an operator gets cleared. My calculator also doesn't allow the user to input an operator as the first character, expect for the negative sign. I created it using React.",
    },
    {
